...
number: 1
name: Keyboard Navigation and Focus Restoration
expected: |
  Tab to a Move Up or Move Down chevron and press Enter or Space to reorder. The link moves. Visual focus is preserved on the clicked button, or shifts to the opposite chevron if a boundary is reached (making the clicked button disabled).
