...
| 2 | Drag-and-Drop Link Ordering | User can reorder microsite links with drag and drop, save order, and public pages display active links in that order. | ORDER-01, ORDER-02, ORDER-03, ORDER-04, ORDER-05 | yes |
